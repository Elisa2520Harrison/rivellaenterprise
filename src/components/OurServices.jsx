  ...
  const services = [
    {
      ...
      description:
        "Celebrate your special moments with healthy, refreshing local beverages and snacks that make every occasion memorable.",
      image: WeddingImg,
    },
    {
      title: "Funerals",
      description:
        "Show care and hospitality during farewells with our authentic local drinks and quality service.",
      image: FuneralImg,
    },
    {
      title: "Corporate Events",
      description:
        "Professional catering for conferences, summits, and business gatherings with exceptional taste.",
      image: CorporateImg,
    },
    {
      title: "Special Events",
      description:
        "From summits to private parties, we bring natural taste and quality service everywhere.",
      image: EventImg,
    },
  ];
    ...
    <section id="services" className="px-4 sm:px-6 py-12 md:py-20">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-base sm:text-lg md:text-xl font-semibold text-gray-800 px-2 sm:px-0 mb-10">
          We provide premium local drinks, fresh fruit juices, and tasty snacks
          for weddings, corporate events, funerals, and special occasions.
        </p>
      </div>
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="relative h-40 sm:h-48 w-full overflow-hidden">
              <img
                src={service.image}
                srcSet={`${service.image} 400w, ${service.image} 800w`}
