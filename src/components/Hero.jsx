...
export default function Hero() {
  return (
    <section id="home" className="relative w-full min-h-screen pt-8">
      ...
      {/* Content */}
      <div
        className="relative z-20 flex items-center justify-center min-h-screen flex-col px-4
       text-center space-y-8"
      >
        <h1
          className="border border-pink-500 rounded-3xl px-6 py-2 text-white font-bold 
        ...
        <h1
          className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-extrabold text-transparent
        ...
        <h3 className="text-white text-2xl float-animation">
          ...
          finest quality, nutrient-rich <br /> beverages and artisanal snacks
          crafted with
          <span className="text-[#f3b925]"> locally sourced ingredients</span>.
        </h3>

        <button
          className="text-white border border-white rounded-2xl w-40 h-10 font-bold 
